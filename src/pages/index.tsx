    ...
    <div className="mx-auto max-w-6xl justify-center pb-4">
      <div className="flex flex-col justify-center px-6 py-4">
        <div className="flex-row gap-4">
          <div className="flex flex-col md:flex-row md:item-center justify-center pb-20 pt-16">
            ...
            <div className="md:pl-12 font-sans">
              ...
              <p className="text-sm text-gray-500">
                ...
                easiest way to add comments or reviews to your static site. Try
                it out by leaving a comment below. After the comment is
                approved, it will display below.
              </p>
